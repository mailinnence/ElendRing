    ...
    public class PlayerManager : CharacterManager
    {
        ...
        public override void OnNetworkSpawn()
        {
            ...
            if (IsOwner)
            {
                ...
                //  UPDATES I STAT BARS WHEN A STAT CHANGE (HEALTH OR STAMINA)
        ...
        public void LoadGaneDataFromCurrentCharacterData(ref CharacterSaveData currentCharacterData)
        {
            ...
            playerNetworkManager.maxHealth.Value = playerStatsManager.CalculateHealthBasedOnVialityLevel(playerNetworkManager.vitality.Value);
